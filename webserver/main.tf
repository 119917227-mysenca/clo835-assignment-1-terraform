...
resource "aws_security_group" "web_sg" {
  ...
  ingress {
    description      = "Allow Custom TCP for ports 8081 From Everywhere"
    from_port        = 8081
    to_port          = 8081
    protocol         = "tcp"
    cidr_blocks      = ["0.0.0.0/0"]
  ...
  ingress {
    description      = "Allow Custom TCP for ports 8082 From Everywhere"
    from_port        = 8082
    to_port          = 8082
    protocol         = "tcp"
    cidr_blocks      = ["0.0.0.0/0"]
  ...
  ingress {
    description      = "Allow Custom TCP for ports 8083 From Everywhere"
    from_port        = 8083
    to_port          = 8083
    protocol         = "tcp"
    cidr_blocks      = ["0.0.0.0/0"]
